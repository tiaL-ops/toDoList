...
|**11**|	Sorting Tasks and Library Fixes	|✅ Implemented task sorting, fixed library issues	- Successfully added sorting functionality to the frontend.| Users can now sort tasks by priority or deadline.|
- Updated the React component to dynamically re-render tasks based on selected sorting criteria.|
